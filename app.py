...
with col2:
    st.subheader("Jitter")
    jitter_percent = st.number_input("Jitter(%)", value=0.007395)
...
with col3:
    ...
    shimmer = st.number_input("Shimmer", value=0.028110)
    shimmer_db = st.number_input("Shimmer(dB)", value=0.27)
    shimmer_apq3 = st.number_input("Shimmer:APQ3", value=0.028110)
    shimmer_apq5 = st.number_input("Shimmer:APQ5", value=0.028110)
    shimmer_apq11 = st.number_input("Shimmer:APQ11", value=0.028110)
    shimmer_dda = st.number_input("Shimmer:DDA", value=0.028110)
    nhr = st.number_input("NHR", value=0.015734)
    hnr = st.number_input("HNR", value=20.326)
